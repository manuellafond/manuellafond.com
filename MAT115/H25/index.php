    ...
    <div id="wrapper">
      ...
      <div id="content">
        ...
        <div class="section">
          ...
          <ul>
            <li>
              <a href='MAT115-planH25.pdf'>Plan de cours</a> 
            </li>
            <li>
        ...
        <div class="section">
          ...
          <ul>
            <li>
              ...
              -- <a href='MAT115-devoir1-sols.pdf'>Mes solutions</a><br>
            </li>
            <li>
              <a href='mat115-devoir2.pdf'>Devoir 2</a><br>
              -- <a href='devoir2-solutions.pdf'>Mes solutions</a>
            </li>
             ...
             <li>
              ...
              -- <a href='devoir3-solutions.pdf'>Mes solutions</a><br>
              -- <a href='dev3-plan-sol.mch'>devoir3-plan-sol.mch</a> (solutions ProB)<br>
            </li>
        ...
        <div class="section">
          ...
          <ul>
            <li>
              <a href='https://marcfrappier.espaceweb.usherbrooke.ca/mat115/logique-sans-solution.pdf'>Notes de cours</a> (écrites par Marc Frappier) <br>
              -- <a href='https://marcfrappier.espaceweb.usherbrooke.ca/mat115/logique-avec-solution.pdf'>avec solutions</a>
            </li>
            <li>
        ...
        <div class="section">
          ...
          <ul>
            ...
            <li style='margin-top:16px'>
              <a href='notes/annexe-intra.pdf'>ANNEXE que vous aurez à l'examen intra</a><br>
            </li>
          ...
          <li>
              <a href='notes/induction.pdf?x=2'>Preuves par induction</a><br>
          </li>
          <!-- li>
              <a href='notes/inegalite.pdf'>Preuves d'inégalités</a><br>
          </li>
            <li>
              <a href='notes/afd.pdf'>Automates</a>  [mises à jour le 9 avril]
              <br>
          </li>
          <li>
              <a href='notes/afdmin.pdf'>Minimisation d'AFD</a>
              <br>
          </li>
            <li style='margin-top:16px;'>
              <a href='notes/finalh24.pdf'>Sujets du final</a>
              <br>
          </li -->
        ...
        <div class="section">
          ...
          <ul>
            <li>
              <a href='https://info.usherbrooke.ca/mfrappier/mat115/logiciels/tarskiUdeS/'>Tarski-UdeS</a><br>
